    ...
    public partial class EditDataForm : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0) // Ensure the row index is valid
            {
                ...
                txtCourseCode.Text = selectedRow.Cells["CourseCode"].Value.ToString();
                txtCourseSubject.Text = selectedRow.Cells["CourseSubject"].Value.ToString();
                txtCourseStrand.Text = selectedRow.Cells["CourseStrand"].Value.ToString();
                txtYearLevel.Text = selectedRow.Cells["YearLevel"].Value.ToString();
